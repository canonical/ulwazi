...
def test_404_page_renders_with_theme():
    ...
    assert page.exists(), (
        "404/index.html not found in docs/_build -- run 'make docs' first"
    )
    ...
    assert Path("docs/_build/_static/404.svg").exists(), (
        "Missing asset: docs/_build/_static/404.svg"
    )
...
def test_404_page_excluded_from_sitemap():
    ...
    assert sitemap.exists(), (
        "sitemap.xml not found in docs/_build -- run 'make docs' first"
    )
