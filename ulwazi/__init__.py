                ...
                match child.text:
                    case "Attention":
                        div_tag = soup.new_tag(
                            "div",
                            attrs={"class": "p-notification--caution", "id": div_id},
                        )
                        title = soup.new_tag(
                            "h5", attrs={"class": "p-notification__title"}
                        )
                    ...
                    case "Error":
                        div_tag = soup.new_tag(
                            "div",
                            attrs={"class": "p-notification--negative", "id": div_id},
                        )
                        title = soup.new_tag(
                            "h5", attrs={"class": "p-notification__title"}
                        )
                    ...
                    case "Hint":
                        div_tag = soup.new_tag(
                            "div",
                            attrs={"class": "p-notification--positive", "id": div_id},
                        )
                        title = soup.new_tag(
                            "h5", attrs={"class": "p-notification__title"}
                        )
...
def _html_page_context(
    ...
    if "toc" in context:
        ...
        context["toc"] = truncate_local_toc(
            context["toc"], getattr(app.config, "localtoc_max_depth", None)
        )
